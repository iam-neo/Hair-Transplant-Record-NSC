var NSC_CONFIG = {
  ...
  sheets: {
    ...
    Photos: ['PhotoID','PhotoSessionID','PatientID','SessionType','Category','PhotoDate','FileName','DriveFileID','MimeType','Size','Notes','CreatedAt'],
...
var ROLE_PERMISSIONS = {
  SUPER_ADMIN: ['*'], ADMIN: ['patients.view','patients.create','patients.edit','patients.archive','consultations.view','consultations.create','consultations.edit','assessments.view','assessments.create','assessments.edit','procedures.view','procedures.create','procedures.edit','photos.view','photos.upload','photos.edit','photos.delete','followups.view','followups.create','followups.edit','followups.complete','followups.cancel','payments.view','payments.create','payments.edit','documents.view','documents.upload','documents.edit','documents.delete','users.view','users.create','users.edit','users.deactivate','reports.view','audit_logs.view'],
  DOCTOR: ['patients.view','patients.create','patients.edit','consultations.view','consultations.create','consultations.edit','assessments.view','assessments.create','assessments.edit','procedures.view','procedures.create','procedures.edit','photos.view','photos.upload','photos.edit','photos.delete','followups.view','followups.create','followups.edit','followups.complete','payments.view','documents.view','documents.upload','documents.edit','documents.delete'],
  ...
  RECEPTION: ['patients.view','patients.create','patients.edit','followups.view','followups.create','followups.edit','payments.view','payments.create']
};
